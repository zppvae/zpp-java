...
import org.java.concurrency.cache.computable.MayFail;
 ...
 */
public class MyCache10<A, V> implements Computable<A, V> {

    private final Map<A, Future<V>> cache = new ConcurrentHashMap<>();

    private final Computable<A, V> c;

    public MyCache10(Computable<A, V> c) {
        this.c = c;
    }
    ...
    public static void main(String[] args) throws Exception {
        MyCache10<String, Integer> expensiveComputer = new MyCache10<>(
                new MayFail());
