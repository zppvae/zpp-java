package org.java.structure.linkedList.seq;

import org.java.structure.linkedList.ISeqList;
...
public class SeqList<T> implements ISeqList<T>{
	...
	private static final int DEFAULT_CAPACITY = 0X4 << 4;
    ...
    public boolean add(int index, T data)
    {
        ...
        //从原数组的最后一个元素开始直到index位置,都往后移动一个位置
        // 最终腾出来的位置就是新插入元素的位置了
...
//    	int DEFAULT_CAPACITY = 0X4 << 4;//4 * 2^4
