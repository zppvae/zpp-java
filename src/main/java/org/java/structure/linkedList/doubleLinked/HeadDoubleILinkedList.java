...
import org.java.structure.linkedList.ILinkedList;
...
public class HeadDoubleILinkedList<T> implements ILinkedList<T> {
	...
	public T get(int index) {
		if (index >= 0) {
			int j = 0;
			// 注意起始结点为this.head.next  this.head无数据
	...
	/**
	 * 根据下标删除结点 1.头删除 2.中间删除 3.尾部删除,更新tail指向
	 * 
	 * @param index
	 *            下标起始值为0
	 * @return
	...
	/**
	 * 根据data删除结点,无需像单向链表那样去存储要删除结点的前一个结点 1.头删除 2.中间删除 3.尾部删除,更新tail指向
	 * 
	 * @param data
	 * @return
	 */
