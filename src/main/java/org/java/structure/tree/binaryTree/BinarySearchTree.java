...
import org.java.structure.queue.LinkedQueue;
import org.java.structure.stack.LinkedStack;
...
//                    queue.add(linkFlag);
    ...
    public static void main(String args[])
    {
         ...
         */
        //先根/中根
//        BinarySearchTree<Strings> cbtree = new BinarySearchTree<>(preList,inList,true);
        //后根/中根
        BinarySearchTree<String> cbtree = new BinarySearchTree<>(postList,inList,false);
//        BinarySearchTree<Strings> cbtree = new BinarySearchTree<>();
